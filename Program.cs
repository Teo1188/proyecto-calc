            ...
            switch (operacion)
            {
                ...
                case "5": // raiz cuadrada
                    ...
                    else
                    {
                        ...
                        Console.WriteLine($"Resultado (Raíz cuadrada de {numero1}): {resultado}");
                    }
                    break;
                case "6": // Elevar un número al cuadrado
                    resultado = Math.Pow(numero1, 2);
                    Console.WriteLine($"Resultado ({numero1}^2): {resultado}");
                    break;
                case "7": // Elevar a un número
                    Console.WriteLine($"Resultado ({numero1} elevado a la {numero2}):");
